 ...
 */
@Slf4j
public class OvaFeignClientInterceptor extends OAuth2FeignRequestInterceptor {
	 ...
	 */
	public OvaFeignClientInterceptor(OAuth2ClientContext oAuth2ClientContext, OAuth2ProtectedResourceDetails resource,
